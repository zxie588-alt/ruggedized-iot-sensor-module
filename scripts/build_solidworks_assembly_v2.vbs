...
lowerPath = asciiCadDir & "\iot_lower_enclosure_v2.SLDPRT"
lidPath = asciiCadDir & "\iot_lid_v2.SLDPRT"
gasketPath = asciiCadDir & "\iot_gasket_v2.SLDPRT"
pcbPath = asciiCadDir & "\iot_pcb_populated_placeholder_v2.SLDPRT"
batteryPath = asciiCadDir & "\iot_battery_placeholder_v2.SLDPRT"
asmPath = asciiCadDir & "\iot_sensor_module_exploded_v2.SLDASM"

CopyPart cadDir & "\iot_lower_enclosure_v2.SLDPRT", lowerPath
CopyPart cadDir & "\iot_lid_v2.SLDPRT", lidPath
CopyPart cadDir & "\iot_gasket_v2.SLDPRT", gasketPath
CopyPart cadDir & "\iot_pcb_populated_placeholder_v2.SLDPRT", pcbPath
CopyPart cadDir & "\iot_battery_placeholder_v2.SLDPRT", batteryPath
...
fso.CopyFile asmPath, cadDir & "\iot_sensor_module_exploded_v2.SLDASM", True
WScript.Echo "Saved assembly: " & cadDir & "\iot_sensor_module_exploded_v2.SLDASM"
WScript.Echo "DONE: SolidWorks V2 assembly generated."
