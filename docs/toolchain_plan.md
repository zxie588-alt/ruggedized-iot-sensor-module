...
3. Create a board-specific `STM32L432KCUx` Keil target after final schematic sign-off, including startup/system files, RTE configuration and flash/HIL evidence.
